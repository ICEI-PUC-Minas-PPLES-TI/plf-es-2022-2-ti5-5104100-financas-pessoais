...
import '../providers/transations_providers.dart';
                ...
                builder: (ctx, snapshot) => snapshot.connectionState ==
                    ...
                    : Consumer<transationsProviders>(
                        ...
                        builder: (ctx, transationsProviders, ch) =>
                            transationsProviders.itemsCount == 0
                                ? ListView.builder(
                                    ...
                                    itemBuilder: (ctx, i) => ListTile(
                                      ...
                                      title: Text(transationsProviders
                                          .itemByIndex(i)
                                          .name),
                                      subtitle: Text(DateFormat("dd/MM/yyyy")
                                          .format(transationsProviders
                                              .itemByIndex(i)
                                              .data)),
                                      // onTap: () {
                                      //   Navigator.of(context).pushNamed(
                                      //     AppRoutes.PLACE_DETAIL,
                                      //     arguments: transationsProviders.itemByIndex(i),
                                      //   );
                                      // },
                                    ),
                                  )
